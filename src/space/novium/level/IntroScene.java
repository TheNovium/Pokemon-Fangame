...
public class IntroScene extends Scene {
    ...
    public void init(){
        ...
        new TextPart("Pokemon Space is currently in an alpha state. Bugs will likely be present, but I'm working on keeping this game as up to date as possible.", new Vector2f(-0.9f, 0.15f), 1.8f, TextAlign.CENTER, theme.getSecondaryFont());
