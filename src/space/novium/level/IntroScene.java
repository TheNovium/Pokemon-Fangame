...
public class IntroScene extends Scene {
    ...
    public void init(){
        ...
        new TextPart("Pokemon Space is currently in an alpha state. Bugs will likely be present, but I'm working on keeping this game as up to date as possible.", new Vector2f(-0.9f, 0.15f), 1.8f, TextAlign.CENTER, GameFonts.BASE_SMALL);
        ...
        new TextPart("https://novium.space", new Vector2f(-0.99f, -0.96f), 1.98f, TextAlign.LEFT, GameFonts.BASE_TINY).setColor(0.85f, 0.6f, 1.0f, 1.0f);
