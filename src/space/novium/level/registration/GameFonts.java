...
public class GameFonts {
    ...
    public static final RegistryObject<FontRenderer> BASE_NORMAL = Registry.FONT_REGISTRY.register("base_white", () -> new FontRenderer(BASE_FONT, Color.WHITE, 128.0f, false));
